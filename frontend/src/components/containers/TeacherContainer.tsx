  ...
  return (
    <>
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow shadow-black/5 dark:shadow-white/5 flex flex-col gap-5 p-5">
          <div className="flex items-center gap-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-white px-3 rounded-full bg-secondary w-fit">{t("Active")}</p>
            </div>
          </div>
